...
namespace WinFormsApp2
{
    public partial class suv : Form
    {
        public suv()
        {
            ...
            comboBox7.Items.Add("205/55R16 91H (1.294,20 TL)");
            comboBox7.Items.Add("175/65R14 82T (900,00 TL)");
            comboBox7.Items.Add("185/65R15 88T (1.187,20 TL)");
            comboBox7.Items.Add("205/55R16 91V (1.376,48 TL)");
            comboBox7.Items.Add("195/65R15 91H (1.075,20 TL)");
            comboBox7.Items.Add("175/70R13 82T (956,00 TL)");
            comboBox7.Items.Add("195/50R15 82H (1.202,50 TL)");
            comboBox7.Items.Add("195/65R15 91T (1.006,40 TL)");
        }
        ...
        {
            pictureBox2.Image = Image.FromFile("C:\\Users\\Aslış\\Desktop\\logo");
        }

        private void pictureBox3_Click(object sender, EventArgs e)
        {
            pictureBox3.Image = Image.FromFile("C:\\Users\\Aslış\\Desktop\\michelin");
        }

        private void pictureBox4_Click(object sender, EventArgs e)
        {
            pictureBox4.Image = Image.FromFile("C:\\Users\\Aslış\\Desktop\\pirelli");
        }

        private void pictureBox5_Click(object sender, EventArgs e)
        {
            pictureBox5.Image = Image.FromFile("C:\\Users\\Aslış\\Desktop\\petlas");
        }

        private void pictureBox6_Click(object sender, EventArgs e)
        {
            pictureBox6.Image = Image.FromFile("C:\\Users\\Aslış\\Desktop\\goodyear");
        }

        private void pictureBox7_Click(object sender, EventArgs e)
        {
            pictureBox7.Image = Image.FromFile("C:\\Users\\Aslış\\Desktop\\kumho");
        }

        private void pictureBox8_Click(object sender, EventArgs e)
        {
            pictureBox8.Image = Image.FromFile("C:\\Users\\Aslış\\Desktop\\conti");
        }

        private void pictureBox9_Click(object sender, EventArgs e)
        {
            pictureBox9.Image = Image.FromFile("C:\\Users\\Aslış\\Desktop\\general");
        }
